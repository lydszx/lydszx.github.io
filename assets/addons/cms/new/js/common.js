...
$(document).ready(function() {
    ...
    $('ul.navigationlist li.mli').bind('mouseover', function() {
        if ($(this).find('ul').children().length > 0) {
            var widthli = $(this).width();
            //widthli=widthli-3;
            $(this).find('ul').width(widthli);
    ...
    // $('ul.navigationlist li.mli').mousemove(function(){
    // 		var widthli=$(this).width();
    // 		//widthli=widthli-3;
    //   $(this).find('ul').width(widthli);
    // 		$(this).find('ul').slideDown(280);//you can give it a speed
    // });
    // $('ul.navigationlist li.mli').mouseleave(function(){
    // 		$(this).find('ul').slideUp(280);
    // });
    //固定导航条
    $("#navigation_main").scrollFix({
        zIndex: 1000
    });
});
//导航下拉结束
